...
function i18n_dict(): array
{
    ...
    $d['fr'] = [
        ...
        'create.my_name_label' => 'Votre nom',
        'create.my_name_help' => 'Affiché comme expéditeur des emails et organisateur de l\'invitation.',
        ...
        'create.duplicate' => 'Dupliquer',
        'create.remove' => 'Retirer',
        'create.dup_warning' => 'Deux créneaux sont identiques (même date et heure).',
        'create.err_duplicate' => 'Créneau en double : « :line » — chaque créneau doit être unique.',
        'create.submit' => 'Créer le déjeuner',
        'create.sec_required' => 'L\'essentiel',
        'create.sec_options' => 'Options (facultatif)',
        'create.min_lead_label' => 'Délai minimum avant un créneau (jours)',
        'create.min_lead_help' => 'Empêche de proposer une date trop proche — vous comme les invités. Ex. 7 = pas de date à moins d\'une semaine.',
        'create.deadline_help' => 'Jusqu\'à quand les invités peuvent s\'inscrire. Laissé vide, il est déduit de vos créneaux.',
        'create.participants_optional' => 'Ajouter des participants directement (facultatif)',
        'create.participants_optional_help' => 'Ils recevront un email d\'invitation. Sinon, partagez simplement le lien de participation obtenu après création (email, WhatsApp…).',
        ...
        'dash.share_h2' => 'Lien de participation',
        'dash.share_help' => 'Partagez ce lien (email, WhatsApp…) : les invités s\'inscrivent et donnent leurs disponibilités eux-mêmes.',
        'dash.share_open_until' => 'Inscriptions ouvertes jusqu\'au :date.',
        'dash.share_closed' => 'Inscriptions closes (date limite dépassée ou déjeuner confirmé).',
        'dash.share_add_slot_lead' => 'Créneau trop proche : au moins le :date (délai mini réglé à :days j).',
        // Page publique de participation
        'join.title' => 'Participer',
        'join.invited_intro' => 'Vous êtes invité·e à ce déjeuner. Indiquez qui vous êtes et vos disponibilités.',
        'join.closed_h1' => 'Inscriptions closes',
        'join.closed_body' => 'Il n\'est plus possible de s\'inscrire à ce déjeuner.',
        'join.your_info' => 'Vous',
        'join.name' => 'Votre nom',
        'join.email' => 'Votre email',
        'join.email_help' => 'Pour vous envoyer le récapitulatif et l\'invitation finale. Vous pourrez modifier vos réponses.',
        'join.deadline_note' => 'Réponses possibles jusqu\'au :date.',
        'join.min_date_note' => 'Les créneaux proposés doivent être au moins le :date.',
        'join.submit' => 'Valider mes disponibilités',
        'join.saved' => 'Merci ! Vos disponibilités sont enregistrées ; un email récapitulatif vous a été envoyé.',
        'join.confirmed_flash' => 'Vos réponses ont permis de confirmer le déjeuner ! Vérifiez votre email.',
        'join.err_name' => 'Indiquez votre nom.',
        'join.err_email' => 'Indiquez un email valide.',
        'join.lead_error' => 'Ce créneau est trop proche : choisissez une date à partir du :date.',
        'join.confirmed_h1' => 'Déjeuner confirmé',
        ...
        'email.confirm.with_guests' => 'Convives :',
        'email.confirm.heading_org' => '✅ Date trouvée : :title',
        'email.confirm.org_intro' => 'Tout le monde est disponible. Les participants ont reçu l\'invitation ; il ne vous reste qu\'à l\'envoyer depuis votre agenda pour en être l\'organisateur — le bouton ci-dessous crée l\'événement avec tous les convives déjà invités :',
        'email.confirm.org_cta' => 'Envoyer l\'invitation depuis mon agenda',
        'email.confirm.org_note' => 'L\'invitation (.ics) est aussi en pièce jointe si vous préférez l\'ouvrir depuis votre logiciel de messagerie.',
    ...
    $d['en'] = [
        ...
        'create.my_name_label' => 'Your name',
        'create.my_name_help' => 'Shown as the sender of the emails and organiser of the invite.',
        ...
        'create.dup_warning' => 'Two slots are identical (same date and time).',
        'create.err_duplicate' => 'Duplicate slot: “:line” — each slot must be unique.',
        'create.submit' => 'Create the lunch',
        'create.sec_required' => 'Essentials',
        'create.sec_options' => 'Options (optional)',
        'create.min_lead_label' => 'Minimum lead time before a slot (days)',
        'create.min_lead_help' => 'Prevents proposing a date that is too soon — for you and guests. E.g. 7 = no date within a week.',
        'create.deadline_help' => 'Until when guests can register. Left empty, it is derived from your slots.',
        'create.participants_optional' => 'Add participants directly (optional)',
        'create.participants_optional_help' => 'They will get an invitation email. Otherwise, just share the participation link you get after creating (email, WhatsApp…).',
        ...
        'dash.share_h2' => 'Participation link',
        'dash.share_help' => 'Share this link (email, WhatsApp…): guests register and give their availability themselves.',
        'dash.share_open_until' => 'Registration open until :date.',
        'dash.share_closed' => 'Registration closed (deadline passed or lunch confirmed).',
        'dash.share_add_slot_lead' => 'Slot too soon: at least :date (minimum lead set to :days d).',
        'join.title' => 'Join',
        'join.invited_intro' => 'You are invited to this lunch. Tell us who you are and your availability.',
        'join.closed_h1' => 'Registration closed',
        'join.closed_body' => 'It is no longer possible to register for this lunch.',
        'join.your_info' => 'You',
        'join.name' => 'Your name',
        'join.email' => 'Your email',
        'join.email_help' => 'To send you the summary and the final invite. You will be able to edit your answers.',
        'join.deadline_note' => 'Replies possible until :date.',
        'join.min_date_note' => 'Proposed slots must be at least :date.',
        'join.submit' => 'Save my availability',
        'join.saved' => 'Thanks! Your availability has been saved; a summary email has been sent to you.',
        'join.confirmed_flash' => 'Your replies confirmed the lunch! Check your email.',
        'join.err_name' => 'Please enter your name.',
        'join.err_email' => 'Please enter a valid email.',
        'join.lead_error' => 'This slot is too soon: pick a date from :date onwards.',
        'join.confirmed_h1' => 'Lunch confirmed',
        ...
        'email.confirm.with_guests' => 'Guests:',
        'email.confirm.heading_org' => '✅ Date found: :title',
        'email.confirm.org_intro' => 'Everyone is available. Participants have received the invite; all that\'s left is to send it from your own calendar so you own the event — the button below creates it with every guest already invited:',
        'email.confirm.org_cta' => 'Send the invite from my calendar',
        'email.confirm.org_note' => 'The invite (.ics) is also attached if you prefer to open it from your mail client.',
