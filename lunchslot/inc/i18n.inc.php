...
function i18n_dict(): array
{
    ...
    $d['fr'] = [
        ...
        'create.participants_label' => 'Participants — une ligne par personne :',
        'create.participants_hint' => 'Nom, email',
        'create.slots_label' => 'Créneaux proposés — une ligne par créneau :',
        'create.slots_hint' => 'AAAA-MM-JJ, HH:MM, durée(min)',
    ...
    $d['en'] = [
        ...
        'create.participants_label' => 'Participants — one person per line:',
        'create.participants_hint' => 'Name, email',
        'create.slots_label' => 'Proposed slots — one slot per line:',
        'create.slots_hint' => 'YYYY-MM-DD, HH:MM, duration(min)',
